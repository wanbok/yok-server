...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { content: @mission.content, duration: @mission.duration, group_id: @mission.group_id }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { content: @mission.content, duration: @mission.duration, group_id: @mission.group_id }
    assert_redirected_to mission_path(assigns(:mission))
  end
